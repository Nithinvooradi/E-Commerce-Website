  ...
  return (
    <div>
      <div className=" relative w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-4">
        <p className="text-red-700 text-base font-inter absolute top-12 right-8 z-[10] rotate-45 font-medium">
          SALE%
        </p>
        <div>
        ...
        <div className="px-8 pb-5">
          ...
          <div className="flex items-center justify-between mt-4">
            <span className="text-base font-bold text-gray-900 dark:text-white">
              <span className="text-red-800">Size Left : </span>
              {defaultSize}
            </span>
            <span className="text-base font-bold text-gray-900 dark:text-white">
              Color:{" "}
          ...
          <div className=" flex justify-between items-center mt-4  border-t-2 p-2">
            ...
            <button
              className="text-xl border border-blue-800 rounded-lg px-6 py-2 w-[70%] hover:bg-blue-800 hover:text-white "
              onClick={() =>
                dispatch(
                  addToCart({
                    id: id,
